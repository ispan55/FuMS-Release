...
_wp = [_group, _destination, 0] call HC_AddWaypoint;
...
{ 
    ...
    _wp2 = [_group, getPos (leader _group) , 0] call HC_AddWaypoint;
    ...
    // add XFill Logic.
    {
        ...
        if (driver (vehicle _x) == _x) then{[_x, _wp, _wp2] execVM "HC\Encounters\AI_Logic\DriverXFill.sqf";};      
