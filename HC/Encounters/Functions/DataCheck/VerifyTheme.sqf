...
{	
    ...
    if ( _dat3 != _theme) exitWith {_abort = true; _msg = format ["%1 Theme name mismatch! Theme name in BaseServerData:%2, found %3 in the actual THEMEDATA. Values MUST MATCH!",_sec, _theme, _dat3];}; 
